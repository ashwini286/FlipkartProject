...
import './DipPurpleIphoneProductsTab.scss'
...
const DipPurpleIphoneProductsTab = () => {
                            ...
                            <Col className='col-lg-4 col-md-6 col-sm-6'>
                                ...
                                >
                                 <div className='big-img-slider'>
                                        <img src={DeepPurpleIphone} alt="Iphone" height={350} width={"100%"} />
                                    </div>
                                    <div className='big-img-slider'>
...
export default DipPurpleIphoneProductsTab
