...
import Samsung from '../../../assets/images/homepage/samsung.png'
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { FaArrowLeftLong } from "react-icons/fa6";
import { Helmet } from 'react-helmet';
import { Button } from 'reactstrap';

const SamGalaxyOrderSummary = () => {
                            ...
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    ...
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">Samsung Galaxy S22 U...  Burgundy 128GB</div>
                                        <div class="product-detail mb-1" id="product-detail">Burgundy</div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/samsung-mobile-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default SamGalaxyOrderSummary
