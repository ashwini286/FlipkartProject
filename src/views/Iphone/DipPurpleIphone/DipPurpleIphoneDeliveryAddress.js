...
const DipPurpleIphoneDeliveryAddress = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if(formData.name, formData.mobile_number, formData.pin){
            window.location.href = `/deeppurple-iphone-order-summary?${queryParams.toString()}`;
        }
        else{
...
export default DipPurpleIphoneDeliveryAddress
