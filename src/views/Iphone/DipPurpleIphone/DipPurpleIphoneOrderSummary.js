                        ...
                        <ul class="list-group list-group-flush" id="deals">
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    <img src={DeepPurpleIphone} alt='Iphone'
                                        id="item_image" width="200px" />
                                    <div class="description">
                                        <div class="product-title mb-1" id="product-title">Apple iPhone 14 Pro ...  Deep Purple 128GB</div>
                                        <div class="product-detail mb-1" id="product-detail">Deep Purple</div>
                                        <img loading="eager" class="_396cs4 _2amPTt _3qGmMb"
                                            alt="APPLE iPhone 14 ((PRODUCT)RED, 128 GB)"
                                            src={DeepPurpleIphone}
                                            width="77px" />
                                    </div>
                                </div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/deeppurple-iphone-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
