...
const MidNightIphoneDeliveryAddress = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if(formData.name, formData.mobile_number, formData.pin){
            window.location.href = `/midnight-iphone-order-summary?${queryParams.toString()}`;
        }
        else{
...
export default MidNightIphoneDeliveryAddress
