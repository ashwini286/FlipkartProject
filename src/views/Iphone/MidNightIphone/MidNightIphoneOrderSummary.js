...
import Iphone from '../../../assets/images/product-details//iphone-all.jpg'
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { FaArrowLeftLong } from "react-icons/fa6";
import { Helmet } from 'react-helmet';
import { Button } from 'reactstrap';

const MidNightIphoneOrderSummary = () => {
                            ...
                            <li class="list-group-item px-0" data-timer="2000">
                                <div class="flex recommended-product">
                                    ...
                                    <div class="description">
                                        ...
                                        <div class="product-detail mb-1" id="product-detail">Midnight</div>
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col">
                                <form >
                                    ...
                                    <button onClick={()=> navigate("/midnight-iphone-payment-details")} type="submit" class="btn bg-warning" >Continue</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
export default MidNightIphoneOrderSummary
